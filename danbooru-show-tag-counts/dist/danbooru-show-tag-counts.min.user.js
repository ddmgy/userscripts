...
"use strict";(()=>{function r({headerSelector:t,tagSelector:e}){let o=$(`h3.${t}-tag-list`);if(o.length===0){console.log(`[danbooru-show-tag-counts] h3.${t}-tag-list does not exist, skipping`);return}$(o).append($("<span></span>",{class:"dstc-post-count",text:$(`.tag-type-${e}`).length,style:"font-weight: normal"}))}function n(){$(".dstc-post-count").remove();let t=[{headerSelector:"artist",tagSelector:"1"},{headerSelector:"copyright",tagSelector:"3"},{headerSelector:"character",tagSelector:"4"},{headerSelector:"general",tagSelector:"0"},{headerSelector:"meta",tagSelector:"5"}];for(let e of t)r(e)}$(n);new MutationObserver((t,e)=>{$(n)}).observe(document.body,{childList:!0,subtree:!0});})();
